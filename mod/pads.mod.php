...
class pads {
	...
	private function showPad($pad = null) {
		...
		return '<html><body style="padding:0px"><iframe src="' . $this->options["eplite_padurl"] . urlencode($pad) . '" style="width:100%; height:100%; border:0px; margin:0px;"></iframe></body></html>';
	}
